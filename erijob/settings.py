"""
Django settings for erijob project.
...
CORS_ALLOW_ALL_ORIGINS = config('CORS_ALLOW_ALL_ORIGINS', cast=bool)  # If this is used then `CORS_ALLOWED_ORIGINS`
...
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', cast=lambda v: [s.strip() for s in v.split(',')])  # If this is used, then not need to use
...
WSGI_APPLICATION = 'erijob.wsgi.application'
